      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><span className="hover:text-white transition-colors cursor-default">{t('contact')}</span></li>
              <li><Link to="/shipping" className="hover:text-white transition-colors">{lang === 'ar' ? 'الشحن' : 'Shipping'}</Link></li>
              <li><Link to="/returns" className="hover:text-white transition-colors">{lang === 'ar' ? 'الاسترجاع' : 'Returns'}</Link></li>
            </ul>
          </div>
        </div>
        <div className="border-t border-neutral-800 mt-12 pt-8 text-xs text-neutral-500">
